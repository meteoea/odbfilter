  ...
  int ProcID, const int Flag[], int row_offset)
{
  ...
  Call_GatherGet_VIEW(ECMA, d, 1, copy_an_depar, pk9real, K1, K2, body, D, an_depar, DATATYPE_REAL8, 0, 0);
  Call_GatherGet_VIEW(ECMA, d, 2, copy_an_depar, pk9real, K1, K2, update_2, D, hires, DATATYPE_REAL8, 0, 0);
  DRHOOK_END(K2-K1);
  return K2-K1;
}
  ...
  int ProcID, const int Flag[])
{
  ...
  ODBMAC_PEINFO_OFFSET();
  Call_ScatterPut_VIEW(ECMA, d, 1, copy_an_depar, pk9real, K1, K2, body, an_depar, D, DATATYPE_REAL8, 0, 0);
  Call_ScatterPut_VIEW(ECMA, d, 2, copy_an_depar, pk9real, K1, K2, update_2, hires, D, DATATYPE_REAL8, 0, 0);
  DRHOOK_END(K2-K1);
  return K2-K1;
}
...
PUBLIC ODB_Funcs *
Anchor2ECMA_copy_an_depar(void *V, ODB_Pool *pool, int *nviews, int it, int add_vars)
{
  VIEW_copy_an_depar *P = V;
  ODB_Funcs *pf;
  DRHOOK_START(Anchor2ECMA_copy_an_depar);
