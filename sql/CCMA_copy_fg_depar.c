  ...
  /* TABLE 'update_1' */ , int N2, unsigned int BmapIdx2[])
{
  ...
  linkoffset_t *Pupdate_1_off = UseDSlong(P->T_hdr, CCMA, linkoffset_t, P->T_hdr->LINKOFFSET(update_1));
  linklen_t *Pupdate_1_len = UseDSlong(P->T_hdr, CCMA, linklen_t, P->T_hdr->LINKLEN(update_1));
  ...
  int ProcID, const int Flag[], int row_offset)
{
  ...
  Call_GatherGet_VIEW(CCMA, d, 1, copy_fg_depar, pk9real, K1, K2, body, D, fg_depar, DATATYPE_REAL8, 0, 0);
  Call_GatherGet_VIEW(CCMA, d, 2, copy_fg_depar, pk9real, K1, K2, update_1, D, hires, DATATYPE_REAL8, 0, 0);
  DRHOOK_END(K2-K1);
  return K2-K1;
}
  ...
  int ProcID, const int Flag[])
{
  ...
  ODBMAC_PEINFO_OFFSET();
  Call_ScatterPut_VIEW(CCMA, d, 1, copy_fg_depar, pk9real, K1, K2, body, fg_depar, D, DATATYPE_REAL8, 0, 0);
  Call_ScatterPut_VIEW(CCMA, d, 2, copy_fg_depar, pk9real, K1, K2, update_1, hires, D, DATATYPE_REAL8, 0, 0);
  DRHOOK_END(K2-K1);
  return K2-K1;
}
...
PUBLIC ODB_Funcs *
Anchor2CCMA_copy_fg_depar(void *V, ODB_Pool *pool, int *nviews, int it, int add_vars)
{
  VIEW_copy_fg_depar *P = V;
  ODB_Funcs *pf;
  DRHOOK_START(Anchor2CCMA_copy_fg_depar);
