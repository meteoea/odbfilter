...
#if (defined(LINUX) && !defined(CYGWIN)) || defined(__APPLE__)
...
extern void *ODB_reserve_mem(size_t size_elem, size_t num_elem, const char *var, const char *file, int linenum);
