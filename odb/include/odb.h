...
oml_lock_t ODB_global_mylock[MAX_ODB_GLOBAL_LOCKS_OPENMP] = { 0 }; /* Specific OMP-locks; GLOBAL-variable; initialized only once in
							     odb/lib/codb.c, routine codb_init_omp_locks_() */
#else
extern ODB_Pool *first_pool;
extern ODB_Pool *last_pool;
extern oml_lock_t ODB_global_mylock[MAX_ODB_GLOBAL_LOCKS_OPENMP];  /* Specific OMP-locks; GLOBAL-variable; initialized only once in
							     odb/lib/codb.c, routine codb_init_omp_locks_() */
#endif
